    ...
    public class DiscoveryManagement
    {
        ...
        public void StartDiscovery()
        {
            try
            {
                ...
                {
                    ApplicationName = "Opc UA Discovery",
                    ...
                    {
                        ApplicationCertificate = new CertificateIdentifier { StoreType = @"Directory", StorePath = @"%CommonApplicationData%\OPC Foundation\CertificateStores\MachineDefault", SubjectName = Utils.Format(@"CN={0}, DC={1}", "KvOpcua", System.Net.Dns.GetHostName()) },
                ...
                Console.WriteLine("启动OPC-UA Discovery服务端");
            }
            catch (Exception ex)
            {
